programa
{
	...
	funcao cadastro_funcionario(inteiro banco_dados, cadeia nome, cadeia telefone, cadeia email, cadeia idade, cadeia cep)
	{
		...
		const inteiro QUANTIDADE_MAXIMA_DE_FUNCIONARIOS = 2

		se(quantidade_de_funcionarios_cadastrados < QUANTIDADE_MAXIMA_DE_FUNCIONARIOS)
		{
		...
		senao
		{
			...
			escreva("\nQuantidade máxima de funcionários atingida!\n\n")
			menu()	
		}
 ...
 * 
 * @POSICAO-CURSOR = 17736; 
 * @DOBRAMENTO-CODIGO = [12, 23, 126, 152, 184, 211, 240, 269, 370, 419, 456, 498, 527, 679, 802, 874, 906, 914, 952, 960, 984, 992, 1003, 1013, 1021, 1032, 1045, 1093, 1108, 1118, 1127, 1136, 1145, 1154, 1164, 1201];
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {quantidade_de_funcionarios_cadastrados, 11, 9, 38};
